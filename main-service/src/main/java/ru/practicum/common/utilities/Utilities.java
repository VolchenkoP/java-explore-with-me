package ru.practicum.common.utilities;
...
public class Utilities {
    ...
    public static List<? extends EventResponseShort> addViewsAndConfirmedRequests(
            List<? extends EventResponseShort> eventRespShorts,
